...
Look up "early onset breast cancer" in Google Scholar and pick a paper to skim.
    ...
    2. What is one thing you learned from this paper: Among Ashkenazi Jews, BRCA1 mutations appear to make a greater contribution to early-onset breast cancer than do BRCA2 mutations.
...
Call the sum function on age_mask. Remember that TRUEs are treated as 1, and FALSEs are treated as 0. Knowing this, what will your sum represent?
    1. Sum = 309; this represents the number of young patients in aggregate (doesn't count the old patients)
...
A common downward trend of survival over time
Both categories plateau over time after a fairly linear downward progression
The young category has a higher survival probability than the old category, for nearly all inputs of f(time).
...
write.csv(clinical, "C:/Users/ac361/Desktop/2022_Fall_QBIO/qbio_490_avinash/brca_clinical_data.csv", row.names = FALSE)
```
